  ...
  <div class="app-container calendar-list-container">
    ...
    <el-table :data="page" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column align="center" label="身份证号" width="200">
        <template scope="scope">{{scope.row.idNo}}</template>
      </el-table-column>
      ...
      <el-table-column align="center" label="监护人手机号" width="200">
        <template scope="scope">{{scope.row.urgentPhone}}</template>
      </el-table-column>
...
<script>
    import { page, updateRole, addStudent } from '@/api/admin/student'
    export default {
        name: 'studentList',
        components: {
