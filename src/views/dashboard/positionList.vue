<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :data="page" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column align="center" label="职务编码" width="180">
      ...
      <el-table-column align="center" label="角色状态" width="150">
        <template scope="scope">{{scope.row.roleStatus}}</template>
      </el-table-column>
...
<script>
    import { posts, first, addCourse, removeCourse, updateRole, getByParent, changeStatus, insertPost, updatePost, deletePost, getPosts, } from '@/api/dashboard/positionLabel'
    import qs from 'qs'
    ...
    export default {
        ...
        methods: {
            ...
            getList() {
                ...
                // }
                getMemberByPost(this.listQuery).then(response => {
